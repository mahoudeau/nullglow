-- Nullglow for Terminal.app
-- Run it AFTER importing Nullglow.terminal:
--   open Nullglow.terminal && osascript nullglow.applescript
--
...
tell application "Terminal"
    set profileName to "Nullglow"

    if not (exists settings set profileName) then
        error "Profile " & profileName & " not found. Open Nullglow.terminal first."
    end if
